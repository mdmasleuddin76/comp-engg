...
const Footer = () => {
  return (
    <div
  className="main-footer bg-neutral-100 text-center text-neutral-600 dark:text-neutral-200 ">
  <div
    ...
    <div className="grid-col-4 grid gap-8 md:grid-cols-2 lg:grid-cols-2">
      ...
      <div className='col-span-1'>
        ...
        <svg
            ...
            viewBox="0 0 24 24"
            fill="currentColor"
            className="mr-3 h-7 w-7 contact-icons-main">
            <path
              fillRule="evenodd"
        ...
        <p className="mb-2 flex item-center justify-center md:justify-start">
        {/* <svg 
  ...
  {/* Copyright section */}
  <div className="main-footer-end bg-neutral-200 p-6 text-center dark:bg-neutral-700">
