  ...
  return (
    <div>
      ...
      <div className="flex h-fit translate-y-12 flex-col border-l-4 border-green-deep px-4 font-semibold">
        ...
        <span className="tex-gray-light mb-3 italic">{professor.areaOfIntrest}</span>
      ...
      {/* </div> */}
        <div>
        <div className="mt-12 mb-12 group relative col-span-1 flex justify-end overflow-hidden rounded-md  px-20 ">
            <div className="bg-[#d7ffdab0] rounded-md hover:bg-green-700 p-2">
            <a href={professor.pdf} className="no-underline ">
                <h3 className="font-semibold" style={{ fontSize: '20px', marginRight: '30px' }}>
                <p className="inline-block"><AiOutlineDownload className="inline-block" /> View Profile</p>
                </h3>
            </a>
            </div>
        </div>
